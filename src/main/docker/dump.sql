...
CREATE TABLE `failed_questions` (
  ...
  `next_ask_time` datetime NOT NULL,
  ...
  KEY `FKjx6o3crr320r1ko5wj5nyknif` (`test_id`),
  KEY `FKoh5n2n6q0dofitq53mllhsgeb` (`user_id`),
  CONSTRAINT `FK9hb7ied6yf2868dw1o8q297k9` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`),
  CONSTRAINT `FKjx6o3crr320r1ko5wj5nyknif` FOREIGN KEY (`test_id`) REFERENCES `tests` (`id`),
  CONSTRAINT `FKoh5n2n6q0dofitq53mllhsgeb` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `test_results` (
  ...
  `failed_questions_amount` int(11) NOT NULL,
...
-- Dump completed on 2017-10-17  0:01:56
